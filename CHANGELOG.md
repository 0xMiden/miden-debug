...
- Function breakpoints wait for entry-block variable declarations instead of stopping before variables are tracked ([#89](https://github.com/0xMiden/miden-debug/issues/89)).
- Stop displaying stale variables after successful program termination in the REPL, TUI, and scripting API, while preserving variable inspection after execution errors ([#90](https://github.com/0xMiden/miden-debug/issues/90)).
