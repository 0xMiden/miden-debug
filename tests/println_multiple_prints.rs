...
use miden_debug::{BreakpointType, PRINTLN_EVENT, PRINTLN_EVENT_ID};

#[test]
fn stepped_println_logs_across_non_printing_steps() {
...
"#,
    ...
    executor
        .step_until(BreakpointType::Event(*PRINTLN_EVENT_ID), None, &source_manager)
        .unwrap();
    assert_println!("hi");
